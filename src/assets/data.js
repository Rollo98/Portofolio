...
const works = [
  {
    ...
    descriptionLarge:
      'This project was created with the help of : React, Node and mainly ThreeJS, which is a cross-browser JavaScript library used to create 3D models and graphics in a web browser using WebGL (Web Graphics Library), which I wanted to become familiar with.',
  ...
  },
  {
    ...
    descriptionLarge:
      'For the development of the application I used: React, Node, Moment Js, Redux and Cookies to remember the user reminders. The purpose of the project was to familiarize myself with the frameworks and best practices.',
  ...
  },
  {
    ...
    descriptionLarge:
      'During the development process I used the following technologies: React Native, Expo, Google APIs. The application goal was to create a path tracking app for mobiles while getting familiar with the technologies that I used.',
